...
function Experience() {
    ...
    const projects: Project[] = [
        {
            id: "bu",
            path: "src/assets/BU.png",
            altText: "Boston University",
            logoPath: "src/assets/BU.png",
        ...
        {
            id: "score",
            path: "src/assets/Score.png",
            altText: "Score Law",
            logoPath: "src/assets/ScoreBlack.png",
            title: "Score Law",
            subtitle: "Co-Founder",
        ...
        {
            id: "telemate",
            path: "src/assets/Telemate.png",
            altText: "Telemate",
            logoPath: "src/assets/TelemateDark.png",
            title: "Telemate AI",
            subtitle: "Co-Founder",
        ...
        {
            id: "914creps",
            path: "src/assets/914creps.png",
            altText: "914creps",
            logoPath: "src/assets/914creps.png",
            title: "914creps",
        ...
        {
            id: "tks",
            path: "src/assets/TKS.png",
            altText: "The Knowledge Society",
            logoPath: "src/assets/TKS.png",
