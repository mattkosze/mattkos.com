import Headshot from '../assets/HeadshotTrimmed.png' 

function Hero() {
    return (
        <div className="text-black flex flex-col-reverse sm:flex-row items-center justify-between px-6 py-20 sm:py-32 gap-4 sm:gap-6 md:gap-10 lg:gap-20">
            ...
            <img src={Headshot} alt="My headshot" className="rounded-full w-40 sm:w-56 md:w-60 lg:w-80 h-auto"/>
        </div>
    )
}
