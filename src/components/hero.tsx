    ...
    return (
        <div className="text-black flex flex-col-reverse sm:flex-row items-center justify-between px-14 py-40 gap-4 sm:gap-6 md:gap-10 lg:gap-20">
            <div className="flex flex-col text-center sm:text-left gap-2 sm:gap-4" >
                ...
                <h2 className="md:max-w-[80%] font-light sm:text-base md:text-base lg:text-xl">I love problem solving and everything I do centers around it. I've worked on startups all throughout college so far, and I'm now joining Bain in Summer of 2026. Currently a junior studying CS + Psych at BU.</h2>
            </div>
